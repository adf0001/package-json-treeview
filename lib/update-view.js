...
var { getContainer, addNode, nodeChildren, nodePart } = require("treeview-model");
...
var updateView = function (el, packageDataset, options) {
	...
	var elVersion = nodePart(elRoot, "pkg-version");
	if (elVersion) elVersion.style.color = "black";
